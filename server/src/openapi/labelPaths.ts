...
registry.registerPath({
    ...
    responses: {
        200: {
            ...
            content: {
                "application/json": { schema: labelListResponseSchema },
            },
        },
        ...authFailureResponses,
    },
...
registry.registerPath({
    ...
    responses: {
        200: {
            ...
            content: { "application/json": { schema: labelResponseSchema } },
        },
...
registry.registerPath({
    ...
    description:
        "Cascades — removes this label from every task it was attached to.",
    security: [{ bearerAuth: [] }],
    request: { params: labelIdParamSchema },
    responses: {
        200: {
            description: "The deleted label.",
            content: { "application/json": { schema: labelResponseSchema } },
        },
        400: validationFailureResponse,
        ...authFailureResponses,
