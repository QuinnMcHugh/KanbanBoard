...
export const createLabelSchema = z
    .object({
        name: z
            ...
            .meta({ description: "Must be unique across all labels.", example: "Frontend" }),
        color: z
            .string()
            .trim()
            .regex(/^#[0-9a-fA-F]{6}$/, "Color must be a hex code like #ff0000.")
            .meta({ description: "6-digit hex color code.", example: "#3b82f6" }),
    })
    .meta({ id: "CreateLabelRequest", description: "Body for creating a label." });
...
export const updateLabelSchema = z
    ...
    .meta({ id: "UpdateLabelRequest", description: "Partial update — at least one field is required." });
...
export const labelSchema = z
    ...
    .meta({ id: "Label", description: "A global label, attachable to any task." });
