...
function handleUniqueConstraintViolation(error: any, res: Response, genericMessage: string) {
...
export async function getLabels(req: Request, res: Response): Promise<void> {
    try {
        ...
        console.error(error);
        res.status(500).json({ error: "Internal server error fetching labels." });
    }
}
...
export async function getLabel(req: Request, res: Response): Promise<void> {
    try {
        ...
        console.error(error);
        res.status(500).json({ error: "Internal server error fetching label." });
    }
}
...
export async function createLabel(req: Request, res: Response): Promise<void> {
    try {
        ...
        handleUniqueConstraintViolation(error, res, "Internal server error creating label.");
    }
}
...
export async function updateLabel(req: Request, res: Response): Promise<void> {
    try {
        ...
        handleUniqueConstraintViolation(error, res, "Internal server error updating label.");
    }
}
...
export async function deleteLabel(req: Request, res: Response): Promise<void> {
    try {
        ...
        console.error(error);
        res.status(500).json({ error: "Internal server error deleting label." });
    }
}
