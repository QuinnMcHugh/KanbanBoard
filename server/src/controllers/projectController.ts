...
function handleForeignKeyConstraintViolation(error: any, res: Response, genericMessage: string) {
    // Handle foreign constraint violations (e.g., owner does not exist)
...
export async function createProject(req: Request, res: Response): Promise<void> {
    try {
        ...
        handleForeignKeyConstraintViolation(error, res, "Internal server error creating project.");
    }
}
...
export async function updateProject(req: Request, res: Response): Promise<void> {
    try {
        ...
        handleForeignKeyConstraintViolation(error, res, "Internal server error updating project.");
    }
}
