...
export async function checkSignupAvailability(
    req: Request<Record<string, never>, unknown, CheckSignupAvailabilityInput>,
    res: Response,
): Promise<void> {
    ...
    if (existingUser) {
        ...
        throw new ConflictError(
            isEmailMatch ? "Email already in use." : "Username already in use.",
        )
    }
